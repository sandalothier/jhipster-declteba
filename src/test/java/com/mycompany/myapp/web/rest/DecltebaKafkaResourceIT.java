...
import com.mycompany.myapp.DecltebaApp;
...
@SpringBootTest(classes = DecltebaApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecltebaKafkaResourceIT {
    ...
    @Autowired
    private DecltebaKafkaProducer producer;

    @Autowired
    private DecltebaKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecltebaKafkaResource kafkaResource = new DecltebaKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/declteba-kafka/publish?message=test"))
